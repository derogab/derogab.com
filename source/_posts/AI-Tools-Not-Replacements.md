...
I build tools for agents — things like the [skills and plugins I collected in Agent Kit](https://derogab.com/2026/02/21/Agent-Kit/) — and I use them constantly. But I use them to skip the boring parts, not the thinking parts. The goal is to remove friction so I can focus on decisions that actually matter. The agent handles syntax. I handle strategy. The agent generates drafts. I shape the message. The agent suggests options. I pick the direction.
...
[header]: /assets/images/linked-to-posts/AI-Tools-Not-Replacements/header.png "Tools, Not Replacements"
